...
Software Engineer based in Dublin, Ireland. I build web applications, backend services, data workflows, automation tools, and cloud-ready systems with a focus on clean implementation and practical delivery.
...
Python · TypeScript · JavaScript · SQL · React · Next.js · Node.js · FastAPI · Flask · Express · PostgreSQL · MongoDB · Docker · AWS · GitHub Actions · Linux

## Technical Expertise

### Full-Stack Web Development

- Built React and Next.js applications with typed components, reusable UI patterns, API integration, routing, dashboards, and responsive layouts
- Developed product-style interfaces for document analysis, job tracking, global data dashboards, real estate listings, and internal automation tools
- Worked across frontend state, backend contracts, deployment configuration, and project documentation instead of only isolated UI screens

### Backend APIs & Services

- Built REST APIs with FastAPI, Flask, Node.js, and Express for scoring engines, document workflows, data processing, and application backends
- Designed service modules for validation, parsing, routing, health checks, background tasks, and external API integration
- Worked with relational and document databases including PostgreSQL, SQLite, MongoDB, and SQLAlchemy-based models

### Data, Search & Automation

- Built retrieval and text-processing systems using BM25, FAISS, embeddings, reranking, NLP pipelines, and structured document parsing
- Developed automation workflows for job discovery, CV processing, web scraping, data extraction, and scheduled analysis
- Created scoring and matching engines for resumes, job descriptions, market data, text signals, and dashboard metrics

### Cloud, DevOps & Engineering Practice

- Configured GitHub Actions workflows for test, lint, build, deployment, security, and infrastructure validation
- Containerised applications with Docker and Docker Compose for reproducible local and production-style environments
- Worked with AWS, Vercel, infrastructure-as-code patterns, environment management, and deployment documentation

### Software Quality

- Prefer simple project structure, clear setup instructions, typed code, explicit validation, and readable documentation
...
- API design, OpenAPI, JSON schemas, Postman
- Authentication, JWT, OAuth concepts, role-based access patterns
- Web scraping, browser automation, data cleaning, scheduled workflows
- Server-side rendering, static generation, dashboard development
- Git, Linux, Bash, package management, environment configuration
